...
@section('title', 'Tambah Sub Operator')

@section('content')
<div class="mb-6 flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-text">Tambah Akun Sub Operator</h1>
        <p class="text-text-secondary mt-1">Buat akun verifikator baru untuk wilayah Kabupaten/Kota tertentu.</p>
    </div>
...
<x-ui.card class="bg-white border border-gray-100 shadow-sm max-w-2xl">
    <form action="{{ route('operator.master-data.sub-operators.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-text mb-1">Kata Sandi (Password) <span class="text-red-500">*</span></label>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                    ...
                    <p class="text-text-secondary">Akun dapat segera digunakan untuk login.</p>
                </div>
            </div>
            
            <div class="bg-blue-50 text-blue-800 text-xs px-3 py-2 rounded border border-blue-200 mt-4">
                Role akun akan otomatis diatur sebagai <strong>Sub Operator</strong> oleh sistem.
            </div>
        </div>
        ...
        <div class="mt-8 flex justify-end gap-3">
            ...
            <x-ui.button type="submit" variant="primary" class="h-10 px-6">Buat Akun</x-ui.button>
        </div>
    </form>
</x-ui.card>
@endsection
