...
<head>
    ...
    <title>419 Sesi Berakhir - SIPKP</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden text-center">
        ...
        <div class="p-8">
            <h1 class="text-6xl font-black text-[#8B0000] mb-2 tracking-tighter">419</h1>
            <h2 class="text-xl font-bold text-gray-800 mb-4 uppercase tracking-wide">Sesi Telah Berakhir</h2>
            <p class="text-gray-600 mb-8 leading-relaxed">
                Halaman telah kedaluwarsa karena Anda terlalu lama tidak aktif. Silakan muat ulang halaman atau login kembali.
            </p>
