...
@php
    ...
    $colors = [
        'default' => [
            'border' => 'border-gray-300', 'accent' => 'text-gray-500', 'solidBg' => 'bg-gray-600',
            'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>'
        ],
        'total' => [
            'border' => 'border-red-600', 'accent' => 'text-red-600', 'solidBg' => 'bg-red-700',
        ...
        'pending' => [
            'border' => 'border-amber-500', 'accent' => 'text-amber-500', 'solidBg' => 'bg-amber-500',
            'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>'
        ],
        'diproses' => [
            'border' => 'border-blue-600', 'accent' => 'text-blue-600', 'solidBg' => 'bg-blue-600',
        ...
        'perlu_perbaikan' => [
            'border' => 'border-orange-500', 'accent' => 'text-orange-500', 'solidBg' => 'bg-orange-500',
            'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>'
        ],
        'disetujui' => [
            'border' => 'border-green-600', 'accent' => 'text-green-600', 'solidBg' => 'bg-green-600',
    ...
    $titleClass = $isSolid ? "text-white/80" : "text-slate-600";
    $valueClass = $isSolid ? "text-white" : "text-slate-900";
    $descClass = $isSolid ? "text-white/80" : "text-slate-600";
    $borderTopClass = $isSolid ? "border-white/20" : "border-gray-100";
    $iconOpacity = $isSolid ? "opacity-20" : "opacity-10";
    $iconColor = $isSolid ? "text-white" : $cfg['accent'];
